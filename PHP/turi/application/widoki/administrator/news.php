    ...
    <div class="wrapright">
	    ...
	    <div id="colRight">
            ...
            <div class="customTable _m5 _fLeft">
	            <div class="tableTitle">Lista wydarzeń</div>
	            <div class="tableContent">
	                <p><?=model_load("newsmodel", "listaWydarzen", "")?></p> 
	            </div>
	            <div class="tableActionButtons"></div>
	        </div>
            
            <div class="customLinkBtn _m5 _fLeft"><a href="administrator/news/view">+ DODAJ NOWY</a></div>

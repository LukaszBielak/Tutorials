    ...
    <div class="wrapright">
	    ...
	    <div id="colRight">
            ...
            <div class="customTable _m5 _fLeft">
	            <div class="tableTitle">Lista sekcji</div>
	            <div class="tableContent">
            	<p><?=model_load("my_modulesmodel", "drawModulesList", "")?></p>
            	</div>          	           
           </div>
           <div class="tableActionButtons"></div>           
           <div class="customLinkBtn _m5 _fLeft"><a href="javascript:void(0);" onclick="addNewModule();">+ NOWA SEKCJA</a></div>  
      </div>
	</div>
	<div id="colLeft">

<!-- widok panelu logowania do palenu admina -->
...
<head>
	...
	<meta name="author" content="MŁukasz Bielak - TuriCMS" />
        ...
        <div class="_content">
            ...
            <div class="inputContainer">
                <form method="POST" action="">
                    ...
                    <div class="_plbl inputLabel _cb _fLeft">Hasło</div><input type="password" value="" name="pass" class="_fLeft customInput" />
